/**
 * Register page: collects new user account details, role selection, and starts
 * teacher onboarding when the selected role is Teacher.
 */
...
const page = () => {
  return (
    <main className="min-h-screen grid lg:grid-cols-2 bg-white">
      ...
      <section className="flex items-center justify-center px-6 md:px-10 py-12">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="mt-3 text-gray-500">
              Join your school workspace and set up your role.
            </p>
          </div>
